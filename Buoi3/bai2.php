...
<body>
    <form action="bai2kq.php" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <table class="table_checkbox">
            ...
            <tr>
                ...
                <td><input name="pay_for4"  type="checkbox" value="55k Category"><label> 75k Category</label></td>
            </tr>
            <tr>
